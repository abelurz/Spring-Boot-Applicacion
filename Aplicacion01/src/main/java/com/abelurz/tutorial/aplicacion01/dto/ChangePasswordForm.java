package com.abelurz.tutorial.aplicacion01.dto;
...
public class ChangePasswordForm {
	...
	@NotBlank(message = "El actual password no debe estar vacio")
	private String currentPassword;
	@NotBlank(message = "El nuevo password no debe estar vacio")
	private String newPassword;
	@NotBlank(message = "La confirmación de password no debe estar vacio")
